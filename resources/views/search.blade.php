    ...
    <div class="wrapper">
        ...
        <section class="content">
            <div class="container">
                ...
                <h2 style="font-weight: bold; margin-top: 30px; padding-left: 20px">Hiển thị tìm kiếm cho "{{$query}}"</h2>
                <div class="col-xs-12"  style="margin-top:20px;">
                  <div class="brandinfo col-xs-12">
                        <h3 class="brandname pull-left">Tìm được {{sizeof($pros)}} kết quả</h3>
                    </div>
                  <?php
                    $j = 0;
                    if(sizeof($pros)>0){
