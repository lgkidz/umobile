...
<body data-spy="scroll" data-offset="0">
  @include('includes.navbar')
        ...
        <section class="content">
            ...
            <div class="order-breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">{{$phone->product_name}}</a></li>
                </ul>
            </div>

            <div class="container">
                <div class="product-intro">
                    <strong style="font-weight: bold; padding-right: 15px">{{$phone->product_name}}</strong>
                ...
                <div class="product-detailed-info">
                    <div class="row">
                        <div class="col-xs-4 item-photo">
                            <img style="max-width:100%;" src="/storage/{{$phone->image}}" />
                        </div>
                        <div class="col-xs-5" style="border:0px solid gray">
                            <h3 class="product-price">{{number_format($phone->price)}} VND</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-5 product-statistics">
                            ...
                            <div class="product-news">
                                <h3 class="product-news-title">Tin tức về {{$phone->product_name}}</h3>
    ...
    <script>
    var cur_product_id = {{$phone->product_id}};
    $.ajaxSetup({
      headers: {
