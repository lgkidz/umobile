...
<!---------------------------------context menu and modal----------------------------------------->
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <form method="post" enctype="multipart/form-data" action="<?php echo e(URL::action('admin_products_controller@editproduct')); ?>">
...
<div class="row">
  <div class="col-xs-12">
    <div class="box box-info">
      <form action="<?php echo e(URL::action('admin_products_controller@addproduct')); ?>" method="post" enctype="multipart/form-data">
