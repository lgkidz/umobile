    ...
    <div class="wrapper">
        ...
        <section class="content">
            <div class="container">
                ...
                <h2 style="font-weight: bold; margin-top: 30px; padding-left: 20px">Hiển thị tìm kiếm cho "<?php echo e($query); ?>"</h2>
                <div class="col-xs-12"  style="margin-top:20px;">
                  <div class="brandinfo col-xs-12">
                        <h3 class="brandname pull-left">Tìm được <?php echo e(sizeof($pros)); ?> kết quả</h3>
                    </div>
                  <?php
                    $j = 0;
                    if(sizeof($pros)>0){
                  ...
                  ?>
                    ...
                    echo "<br><br><br><h4>Không có kết quả tìm kiếm nào</h4>";
                  }
                   ?>
                </div>
            </div>
