      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          <div class="box box-success">
            ...
            <div class="box-body">
              <form method="post" action="<?php echo e(URL::action('admin_brands_controller@insert')); ?>">
...
function showcontextmenu(id){
  ...
  function editbrand(id){
    ...
    editform += '<form id="edit_form" method="post" action="<?php echo e(URL::action('admin_brands_controller@edit')); ?>">';
...
<form id="deleteform" method="post" action="<?php echo e(URL::action('admin_brands_controller@delete')); ?>">
  <?php echo e(csrf_field()); ?>
