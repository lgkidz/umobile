                                    ...
                                    <div class="panel panel-body">
                                        <div class="row">
                                            <div class="col-md-4 col-lg-4" align="center">
                                                <img src="<?php if($mem->avatar != null && $mem->avatar != ""): ?>
                                                  /storage/<?php echo e($mem->avatar); ?>

                                                <?php else: ?>
                                                  img/defaultface.jpg
                                                <?php endif; ?>" class="img img-responsive img-circle" id="uavatar" alt="" style="width: 200px; height: 200px;">
                                            </div>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="spec-content">
                                                                <span id="name_field"><?php echo e($mem->first_name); ?> <?php echo e($mem->last_name); ?></span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td class="spec-title">
                                                            ...
                                                            <td class="spec-content">
                                                                <span id="gender_field"><?php if($mem->gender): ?>
                                                                  <?php echo e($mem->gender); ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="spec-content">
                                                                <span id="address_field"><?php if($mem->address): ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="spec-content">
                                                                <span id="phone_field"><?php if($mem->phone): ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="spec-content">
                                                                <a href="mailto:<?php echo e($mem->email); ?>"><?php echo e($mem->email); ?></a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                ...
                                <div class="panel panel-info">
                                    ...
                                    <div class="panel panel-body">
                                        <table class="table table-striped table-hover table-list-orders">
                                            <thead>
                                                <tr>
                                                    <th colspan="7"><h4 style="text-align: left;font-weight: bold">Bạn có <?php if($data != null): ?>
                                                      <?php echo e(sizeof($data)); ?>

                                                    <?php else: ?>
                                                      0
                                                    <?php endif; ?> đơn hàng</h4></th>
                                                </tr>
                                                <tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="img-select-block">
                        ...
                        <img id="avatar" src="<?php if($mem->avatar != null && $mem->avatar != ""): ?>
                          /storage/<?php echo e($mem->avatar); ?>

                        <?php else: ?>
                          img/defaultface.jpg
                        <?php endif; ?>" class="img img-responsive img-circle" alt="" style="height: 100px; width:100px">
                        <input type="file" id="input-select-img-avatar" name="avatar" onchange="loadFile(event)">
                    </div>
                    <div class="form-group">
                        <label>Họ: </label>
                        <input type="text" class="form-control" name="fname" id="input-name" value="<?php echo e($mem->first_name); ?>">
                        <label>tên: </label>
                        <input type="text" class="form-control" name="lname" id="input-name" value="<?php echo e($mem->last_name); ?>">
                    </div>
                    <div class="form-group">
                        <label>Giới tính: </label>
                        <select class="form-control" name="gender" id="gender">
                            <option value="Nam" <?php if($mem->gender == "Nam"): ?>
                              selected
                            <?php endif; ?>>Nam</option>
                            <option value="Nữ" <?php if($mem->gender == "Nữ"): ?>
                              selected
                            <?php endif; ?>>Nữ</option>
                            <option value="Khác" <?php if($mem->gender == "Khác"): ?>
                              selected
                    ...
                    <div class="form-group">
                        <label>Địa chỉ: </label>
                        <input type="text" class="form-control" name="address" id="input-address" value="<?php echo e($mem->address); ?>">
                    </div>
                    <div class="form-group">
                        <label>Số điện thoại: </label>
                        <input type="text" class="form-control" name="phone" id="input-phone" value="<?php echo e($mem->phone); ?>">
                    </div>
                </div>
                </form>
